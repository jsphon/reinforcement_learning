...
from rl.tests.core.learning.example_rl_system import MockState1, MockState2A, MockState2B, MockState3
from rl.tests.core.learning.example_rl_system import MockSystem
from rl.tests.core.learning.example_state_machine_rl_system import MockStateMachineSystem, AgentLocation
...
class StateMachineTargetArrayCalculatorTests(unittest.TestCase):
    ...
    def test_get_target_matrix(self):
        ...
        external_state1 = AgentLocation(1)
        external_state2 = AgentLocation(2)
